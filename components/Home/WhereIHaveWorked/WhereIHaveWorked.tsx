...
import Cemtrex from "./Descriptions/Cemtrex";
import Hbwsl from "./Descriptions/hbwsl";
...
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("cemtrex");
  return (
...
const CompaniesBar = props => {
  const [barPosition, setBarPosition] = React.useState<Number>(60); // Green bar position by the default it's -20px
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        <div className="flex flex-row md:flex-col">
          <CompanyButton
            ...
            BarPosition={60}
            BarAvobePosition={1}
            DescriptionJob="cemtrex"
            CompanyNameBackgroundColorGreen={[true, false, false, false, false]}
            setDescriptionJob={props.setDescriptionJob}
          />
          <CompanyButton
            ButtonOrderOfcompanyNameBackgroundColorGreen={1}
            CompanyName="Hummingbird Web Solutions Pvt Ltd"
            BarPosition={105}
            BarAvobePosition={129}
            DescriptionJob="hbwsl"
